    ...
    >
        <div>
            ...
            <small v-if="isEditing" class="ml-2"
                >Press <span class="text-green-600">enter</span> to submit or
                press <span class="text-red-400">escape</span> to cancel</small
            >
        </div>
        <Button
            v-if="!isEditing"
        ...
        />
        <Hotkey
            :hotkey="hotkeys.characters.rename"
            hidden
            @press="startEditing"
        />
